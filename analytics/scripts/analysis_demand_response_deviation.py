...
CLASS_NAME = "DemandResponseDeviationAnalysis"
...
class DemandResponseDeviationAnalysis(Analysis):
    ...
    def _analyze(self, p, d):
        try:
            ...
            dev = self._deviation(b_discharged, b_to_compare, self.target_day)
    ...
    def _deviation(self, b_d, b_c, c_date):
        """
